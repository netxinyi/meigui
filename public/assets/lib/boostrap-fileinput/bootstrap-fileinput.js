...
!function (e) {
    ...
    i = function (e) {
        ...
        data: {}, init: function (e) {
            ...
            var n = a.config[i], l = _("caption", n) ? n.caption : "", o = _("width", n) ? n.width : "auto", s = _("url", n) ? n.url : !1, d = _("key", n) ? n.key : null, c = s === !1 && t, p = a.isDelete ? a.actions(!1, !0, c, s, d) : "", u = a.footer.replace(/\{actions}/g, p);
        ...
        constructor: Y, validate: function () {
            ...
            if (this.showPreview) {
                var n, l, o, s = this, d = s.parseFileType(i), c = i ? i.name : "", p = s.slug(c), u = s.allowedPreviewTypes, f = s.allowedPreviewMimeTypes, v = s.getPreviewTemplate(d), g = u && u.indexOf(d) >= 0, m = _(d, s.previewSettings) ? s.previewSettings[d] : Z[d], h = f && -1 !== f.indexOf(i.type), w = s.renderFileFooter(p, m.width), b = "", C = a.slice(a.lastIndexOf("-") + 1);
            ...
            a.loadedImages = [], a.totalImagesCount = 0, e.each(i, function (e, i) {
                var t = "image", r = _(t, a.fileTypeSettings) ? a.fileTypeSettings[t] : H[t];
        ...
        if (l() || i(9)) {
            ...
            switch (a.shift(), this.each(function () {
                var i = e(this), n = i.data("fileinput"), l = "object" == typeof t && t, o = l.language || i.data("language") || "en", s = e.fn.fileinput.defaults;
