...
var handleSlimScroll = function () {
    ...
    var active = $(".sidebar .nav>li a[href='" + href + "']");
    if (active.length < 1) {
        var pathname = window.location.pathname.split('/');
        var path = window.location.origin + "/" + pathname[1] + "/" + pathname[2];
        active = $(".sidebar .nav>li a[href='" + path + "']");
    } else {
        active.parent('li').addClass('active');
    }

    active.parents('ul.sub-menu').show();
    active.parents('li.has-sub').addClass('expand').addClass('active');
    ...
    function e(e, a) {
        ...
        if ($(e).find("li.active").prevAll().each(function () {
            ...
            var l = i - t;
            o != i && (l += 40), $(e).find(".nav.nav-tabs").animate({marginLeft: "-" + l + "px"}, n)
        }
    ...
    function a(e, a) {
        var t = $(e).closest(".tab-overflow"), i = parseInt($(t).find(".nav.nav-tabs").css("margin-left")), n = $(t).width(), o = 0, l = 0;
        switch ($(t).find("li").each(function () {
            ...
            case"next":
                ...
                }, 150)) : l = n - i - 80, 0 != l && $(t).find(".nav.nav-tabs").animate({marginLeft: "-" + l + "px"}, 150, function () {
                    $(t).addClass("overflow-left")
                });
                break;
            case"prev":
                var s = -i;
                n >= s ? ($(t).removeClass("overflow-left"), l = 0) : l = s - n + 80, $(t).find(".nav.nav-tabs").animate({marginLeft: "-" + l + "px"}, 150, function () {
    ...
    $('a[data-method]').click(function () {
        ...
        if (method.toUpperCase() in ["GET", "POST"]) {
            $form.attr('method', method);
        } else {
            $form.attr('method', 'POST');
            $form.append('<input name="_method" value="' + method + '">');
        }

        var csrf = $('meta[name="csrf-token"]').attr('content');
        $form.append('<input name="_token" value="' + csrf + '">');
        $form.submit();
    ...
    $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").live("touchstart", function (a) {
        ...
        } else parseInt(e) >= 0 && $(a).animate({marginTop: "0px"});
        return !0
    })
}, App = function () {
    "use strict";
