...
class Card
{
    ...
    public function getTicket()
    {
        ...
        return $this->ticket = $this->cache->get($key, function ($key) use ($http, $cache, $apiTicket){
    ...
    public function attachExtension($cardId, array $extension = array())
    {
        ...
        $ext['signature'] = $this->getSignature($this->getTicket(), $timestamp, $cardId, $ext['code'], $ext['openid'],
            $ext['balance']);
