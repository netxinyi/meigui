...
<head lang="en">
  ...
  <style>
    /*头部样式*/
    .am-header-default{background-color:#f15481;}

    /*背景颜色*/
    body{background-color: #fff;}

    /*按钮颜色*/
    .btn_color{background-color:#f15481;}
  </style>
...
<div>
  <form class="am-form" action="{{url('weixin/signup')}}" method="post">
  ...
  <fieldset>
      ...
      <font color="red"><?php echo $errors->first('realname'); ?></font>
      <div class="am-form-group">
     ...
     <div class="am-form-group">
      ...
      <select name="marital_status" id="doc-select-1">
