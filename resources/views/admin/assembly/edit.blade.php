...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            @endif
                <form action="{{route('admin.assembly.update',['assembly_id'=>$model->assembly_id])}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="index_status" class="form-control">
                            @foreach(\App\Enum\Assembly::$displayLang as $value=>$lable)
                                <option value="{{$value}}" @if(old('index_status',$model->index_status) == $value)
