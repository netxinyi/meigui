        ...
        <ul class="nav">
            ...
            <li class="has-sub">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="ui_language_bar_icon.html">Language Bar & Icon <i
            ...
            <li class="has-sub">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="page_with_wide_sidebar.html">Page with Wide Sidebar <i
                                    class="fa fa-paper-plane text-theme"></i></a></li>
                    <li><a href="page_with_light_sidebar.html">Page with Light Sidebar <i
                                    class="fa fa-paper-plane text-theme"></i></a></li>
                    <li><a href="page_with_mega_menu.html">Page with Mega Menu <i
                                    class="fa fa-paper-plane text-theme"></i></a></li>
                </ul>
            </li>
            <li class="has-sub">
