...
@section('content')
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title">编辑案例 -{{$case->title}} </h4>
        </div>
        <div class="panel-body">
            ...
            @endif
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" placeholder="案例标题" name="title"
                           value="{{$case->title}}">
                    @if($errors->has('title'))
                    ...
                    <div class="form-group">
                        <label for="title">男主角</label>
                        <input type="text" class="form-control" id="title" placeholder="男主角" name="male_id"
                               value="{{$case->male_id}}">
                    ...
                    <div class="form-group">
                        <label for="title">女主角</label>
                        <input type="text" class="form-control" id="title" placeholder="女主角" name="female_id"
                               value="{{$case->female_id}}">
