...
@section('title')
    ...
    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        <div class="panel-heading">
            ...
            <h4 class="panel-title">添加会员 - {{$user->realname}}</h4>
        </div>
        <div class="panel-body">
            ...
            @endif
            <form class="form-horizontal" action="/admin/user/{{$user->id}}/add" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select name="height" class="form-control">
                                ...
                                @for($i=130; $i <=210;$i++)
                                    <option value="{{$i}}" @if(old('height') == $i) selected @endif >{{$i}} cm</option>
                                @endfor
                            </select>
