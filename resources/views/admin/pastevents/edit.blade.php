...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            ...
            @endif
                <form id="fileupload" action="{{route('admin.pastevents.update',['pastevents_id'=>$model->pastevents_id])}}" method="post" enctype="multipart/form-data">
                ...
                <span class="btn btn-success fileinput-button">
                    ...
                    <input type="file" name="image" multiple>
                                ...
                                <span style="color:red">如需修改图片，请重新上传一张图片,图片尺寸<span style="color:blue">600*400像素</span></span>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="photos">
                                        <div class="photo">
                                            <input type="hidden" name="event_img" value="{{$model->event_img}}">
                                            <img src="{{$model->event_img}}" width="110" height="110">
                                        </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label>&nbsp;</label>
                        <button type="submit" name="_method" value="put" class="btn btn-sm btn-success pull-right">&nbsp;发&nbsp;布&nbsp;</button>
                </div>
    ...
    <script type="text/javascript">
        ...
        $("#fileupload").fileupload({
            ...
            downloadTemplate: 'template-download',
                ...
                $('#fileupload').append('<input type="hidden" name="event_img" value="' + url + '">');
                return true;
            },
